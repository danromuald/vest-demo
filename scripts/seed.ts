...
**Stop loss**: $65 (regulated utility sum-of-parts value)`
    ...
    // =====================================================================
    // NOTE: CVX is created as a RESEARCH REQUEST only (no workflow/proposal yet)
    // This demonstrates the "Create Proposal" button UI state
    // CVX research request and agent responses are created later in this script
    // =====================================================================
...
**Expected Completion**: 7-10 days`
    ...
    console.log("  - 7 research requests (GOOGL, AMZN, CVX, TSLA, META + NEE, NVDA)");
    console.log("  - 9 research artifacts across workflows");
    console.log("  - 2 IC meetings with debate sessions:");
